...
| **G39** | **UE radio capability** — store from UERadioCapabilityInfoIndication, replay in ICS/HandoverRequest | Minor | S | P2 | **✅ done ([158](158-ue-radio-capability.md))** — store + ICS replay; HandoverRequest replay deferred. open5gs is the working oracle; free5gc's is stubbed |
